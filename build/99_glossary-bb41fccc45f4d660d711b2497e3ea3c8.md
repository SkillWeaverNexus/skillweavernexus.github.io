...
:::{glossary}
Fate Roll
: A special `d20` roll, usually made without modifiers, to capture moments of pure fate or chance. A Fate Roll Table (e.g., for [Snake Eye Rolls](rolls#fate-rolls)) will usually dictate how to interpret the outcomes of this roll. 
:::

:::{glossary}
Arcane Toxicity
: A cumulative effect from the process of casting magic, using magic equipment, or being healed by magic. [See More](arcane-toxicity).
:::

:::{glossary}
Environmental Turn 
: The second turn of every combat round, during which environmental effects, lair actions, death fate rolls, surprise reactions, etc. take place. [See: Initiative](initiative)
:::

:::{glossary}
Ability Roll 
: Any time you make a dice roll using one of the core dice (d4-d12). Ability checks, attacks, etc., all count as ability rolls.
:::

:::{glossary}
Cover Area
: A contiguous area of partial or full cover, like a wall, pillar, or hedge, of up to 20 ft in any dimension. Larger cover can be considered multiple Cover Areas at a GM's discretion. Relevant for 