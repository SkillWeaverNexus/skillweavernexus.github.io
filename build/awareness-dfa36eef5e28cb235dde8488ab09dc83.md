...
Only creatures with known location can be directly targeted by actions like attacks or spells. 
...
```{note}
While direct attacks cannot be made against creatures with unknown locations, t
``` 
