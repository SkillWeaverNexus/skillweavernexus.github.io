...
In order to wear this armor set, you must have at least a `d8` in your Physicality {term}`Core Skill`. While wearing it, it negates the first 6 points of bludgeoning damage (and first 4 points of slashing or piercing damage) from any attack you take. But it's heavy, and parrying while wearing it costs a total of 2 stamina, while dodging is extremely stamina draining (4 stamina to dodge). And on top of this, 