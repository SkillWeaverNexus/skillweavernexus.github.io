...
:::{admonition} Example
The [Healer](/origins/nature/healer) origin has an ability in which allies starting their turn within 5 ft of them gain `1d4` temp HP. If you start your turn next to them, you might roll 1, and gain 1 temp HP. If your next turn also starts next to them, you can choose to drop the 1 temp HP to 
:::
