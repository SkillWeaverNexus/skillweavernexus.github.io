...
:open:
WR: Physicality d8 
Damage Reduction: 6 (bludgeoning), 4 (slashing)
Parry: +1 stamina 
Dodge: +2 stamina 
Movement: reduced by 5ft
:::

In order to wear this armor set, you must have at least a `d8` in your Physicality {term}`Core Skill`. While wearing it, it negates the first 6 points of bludgeoning damage (and first 4 points of slashing )